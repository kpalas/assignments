...
## 🚀 How to Navigate
Each major folder contains its own detailed `README.md` with specific instructions on how to compile, run, and test that specific project. 

* **Java Projects:** Can be compiled via the command line using `javac *.java`.
* **iOS Projects:** Require macOS and **Xcode** to build and run the `.xcodeproj` files in a simulator.
* **SQL Projects:** Provide `.sql` scripts that can be executed in MySQL Workbench or any standard SQL client to generate the schemas and test data.
